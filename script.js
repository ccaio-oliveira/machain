...
const translations = {
    'pt': {
        ...
        'cta-main': 'CONHEÇA A MACHAIN',
                ...
                // Section 1 - Hero
        'hero-title-part1': 'DO IMÓVEL AO TOKEN.',
        'hero-title-part2': 'TUDO EM UM STACK.',
        'hero-subtitle': 'TOKENIZAÇÃO COM ESTRUTURA JURÍDICA, CONSTRUÍDA PARA OPERAR EM ESCALA',
        'hero-description': 'A Matchain torna a tokenização simples, segura e compatível. Cada token é baseado em direitos executáveis, projetado para operação contínua e pronto para escalar desde o primeiro dia. A IA alimenta verificações de documentos, correspondência de identidade e validação de dados, para que cada ativo permaneça preciso, auditável e legalmente compatível.',
        ...
        'section2-subtitle1-line1': 'A ADOÇÃO INSTITUCIONAL COMEÇOU.',
        'section2-subtitle1-line2': 'QUEM SE MOVE PRIMEIRO VAI LIDERAR.',
        'section2-subtitle': 'A tokenização está ajudando as instituições a reduzir o atrito operacional e acessar novas formas de liquidez. Do crédito privado ao mercado imobiliário, bilhões em ativos já estão tokenizados e ativamente gerenciados on-chain, com a clareza regulatória impulsionando a adoção.',
        'card-brasil-desc': 'VALOR MOVIMENTADO NO BRASIL SETOR IMOBILIÁRIO EM 2024',
        ...
        // Seção 3
        'section3-title-part1': 'ENTREGAMOS',
        'section3-title-highlight1': 'INFRAESTRUTURA FINANCEIRA',
        'section3-title-highlight2': 'FUNCIONAL',
        'section3-description': 'Cada tokenização é entregue como um produto financeiro legalmente estruturado e totalmente operacional, com compliance, governança, custódia e onboarding de investidores integrados. Não é middleware. É a infraestrutura por trás de ativos reais em movimento.',
        'result-text': 'Projetado para atender requisitos legais, operacionais e de investidores desde o primeiro dia.',
        
        // Seção 4
        'section4-title-highlight': 'IMÓVEIS, ESTRUTURADOS',
        'section4-title-light': 'PARA O MERCADO MODERNO',
        'section4-subtitle': 'A TOKENIZAÇÃO LIBERA NOVA LIQUIDEZ, SIMPLIFICA O FINANCIAMENTO E OTIMIZA COMO OS EMPREENDIMENTOS SÃO ESTRUTURADOS E VENDIDOS.',
        'section4-description': 'Incorporadores líderes já estão usando modelos tokenizados para gerenciar projetos com mais eficiência, desde a formação de capital até a transferência de ativos. A Matchain oferece os trilhos legais, financeiros e técnicos para mover imóveis on-chain, sem comprometer compliance ou controle.',
        ...
        'audience-proprietarios': '/ PROPRIETÁRIOS DE IMÓVEIS',
        ...
        'audience-proprietarios-ativos': '/ PROPRIETÁRIOS DE ATIVOS E DIREITOS',
        ...
        'governance-estruturas-title': 'ESTRUTURAS LEGAIS',
        ...
        'governance-protecao-desc': 'em conformidade com LGPD',
    ...
    'en': {
        ...
        // Section 1 - Hero
        'hero-title-part1': 'FROM PROPERTY TO TOKEN.',
        'hero-title-part2': 'ALL IN ONE STACK.',
        'hero-subtitle': 'TOKENIZATION WITH LEGAL STRUCTURE, BUILT TO RUN AT SCALE',
        'hero-description': 'Matchain makes tokenization simple, secure, and compliant. Each token is grounded in enforceable rights, designed for continuous operation, and ready to scale from day one. AI powers document checks, identity matching, and data validation, so every asset stays accurate, auditable, and legally compliant.',
        ...
        'section2-subtitle1-line1': 'INSTITUTIONAL ADOPTION HAS STARTED.',
        'section2-subtitle1-line2': 'EARLY MOVERS WILL LEAD.',
        'section2-subtitle': 'Tokenization is helping institutions reduce operational friction and access new forms of liquidity. From private credit to real estate, billions in assets are already tokenized and actively managed on-chain, with regulatory clarity driving adoption.',
        'card-brasil-desc': 'VALUE MOVED IN BRAZIL REAL ESTATE SECTOR IN 2024',
        'card-brasil-value': 'R$ 229 BILLION',
        'card-global-desc': 'THE GLOBAL VALUE OF REAL ESTATE MARKET RECORDED IN RWA',
        'card-global-value': 'US$ 11 TRILLION',
        
        // Section 3
        'section3-title-part1': 'WE SHIP WORKING',
        'section3-title-highlight1': 'FINANCIAL INFRASTRUCTURE',
        'section3-title-highlight2': ' ',
        'section3-description': 'Every tokenization is delivered as a legally structured, fully operational financial product with compliance, governance, custody, and investor onboarding built in. It\'s not middleware. It\'s the infrastructure behind real assets in motion.',
        'result-text': 'Designed to meet legal, operational, and investor requirements from day one.',
        
        // Section 4
        'section4-title-highlight': 'REAL ESTATE, STRUCTURED',
        'section4-title-light': 'FOR THE MODERN MARKET',
        'section4-subtitle': 'TOKENIZATION UNLOCKS NEW LIQUIDITY, SIMPLIFIES FUNDING, AND STREAMLINES HOW DEVELOPMENTS ARE STRUCTURED AND SOLD.',
        'section4-description': 'Leading developers are already using tokenized models to manage projects more efficiently, from capital formation to asset transfer. Matchain delivers the legal, financial, and technical rails to move real estate on-chain, without compromising compliance or control.',
        
        // Section 5
        'section5-title-bold': 'HOW WE EXECUTE IN',
        'section5-title-light': 'PRACTICE:',
        'process-card1-title': 'DEEP DUE DILIGENCE',
        'process-card1-desc': 'Eligibility evaluation, risk analysis and economic viability. Only assets with solid fundamentals proceed.',
        'process-card2-title': 'TOKEN ENGINEERING',
        'process-card2-desc': 'Customized smart contract design, rights definition, distribution rules and governance mechanisms.',
        ...
        'process-card5-desc': 'Enterprise blockchain deployment, security testing and complete technical validation before go-live.',
        ...
        'benefit1-desc': 'Intelligent fractionalization and 24/7 trading',
        ...
        'benefit5-title': 'ADAPTATION TO TRADITIONAL MARKET:',
        'benefit5-desc': 'Tokenization integrated to the classic model, with legal security.',
        ...
        'audience-proprietarios': '/ REAL ESTATE OWNERS',
        ...
        'audience-proprietarios-ativos': '/ ASSET AND RIGHTS OWNERS',
        ...
        'governance-kyc-desc': 'with source of funds verification',
        ...
        'governance-protecao-desc': 'in compliance with LGPD',
